    ...
    <SiteLayout>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-5xl px-6 lg:px-10 space-y-6">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Foxmarine Nigeria Limited is a professionally structured and forward-thinking
            dredging company specializing in comprehensive sand dredging services across
            marine and inland environments. The company is committed to delivering
            high-quality, efficient, and environmentally responsible dredging solutions
            tailored to meet the needs of both public and private sector clients.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed">
            With a strong operational base in the Niger Delta region of Nigeria, Fox
            Marine has built a reputation as a dependable, results-driven partner in
            dredging and marine engineering projects — integrating technical expertise,
            modern equipment, and a highly skilled workforce to execute projects of
            varying sizes and complexities.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Incorporated under the Companies and Allied Matters Act on 2nd March 2009
            (RC 504645), Fox Marine continues to play a significant role in supporting
            infrastructure development, shoreline protection, land reclamation, and
            sustainable resource utilisation within Nigeria and beyond.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-secondary">
        <div className="mx-auto max-w-5xl px-6 lg:px-10">
          <div className="text-[10px] uppercase tracking-[0.4em] text-accent mb-4">Selected Track Record</div>
          ...
          <ol className="space-y-4">
            {[
              ...
              <li key={p} className="flex gap-4 bg-card border border-border rounded-md p-5">
                <span className="font-display text-2xl text-gold font-semibold">{String(i + 1).padStart(2, "0")}</span>
